...
var _ resource.ResourceWithIdentity = &CertificateResource{}
...
func (r *CertificateResource) IdentitySchema(_ context.Context, _ resource.IdentitySchemaRequest, resp *resource.IdentitySchemaResponse) {
