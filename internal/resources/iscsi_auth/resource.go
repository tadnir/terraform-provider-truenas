...
var _ resource.ResourceWithIdentity = &ISCSIAuthResource{}
...
func (r *ISCSIAuthResource) IdentitySchema(_ context.Context, _ resource.IdentitySchemaRequest, resp *resource.IdentitySchemaResponse) {
