...
func TestListMetadata(t *testing.T) {
	l := &ISCSIExtentListResource{}
	req := resource.MetadataRequest{ProviderTypeName: "truenas"}
	resp := &resource.MetadataResponse{}
	l.Metadata(context.Background(), req, resp)
	if resp.TypeName != "truenas_iscsi_extent" {
		t.Errorf("TypeName = %q, want %q", resp.TypeName, "truenas_iscsi_extent")
	}
}

func TestISCSIExtentIdentitySchema(t *testing.T) {
