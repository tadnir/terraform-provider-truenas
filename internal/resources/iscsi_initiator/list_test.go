...
func TestListMetadata(t *testing.T) {
	l := &ISCSIInitiatorListResource{}
	req := resource.MetadataRequest{ProviderTypeName: "truenas"}
	resp := &resource.MetadataResponse{}
	l.Metadata(context.Background(), req, resp)
	if resp.TypeName != "truenas_iscsi_initiator" {
		t.Errorf("TypeName = %q, want %q", resp.TypeName, "truenas_iscsi_initiator")
	}
}

func TestISCSIInitiatorIdentitySchema(t *testing.T) {
