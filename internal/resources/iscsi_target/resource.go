...
var _ resource.ResourceWithIdentity = &ISCSITargetResource{}
...
func (r *ISCSITargetResource) IdentitySchema(_ context.Context, _ resource.IdentitySchemaRequest, resp *resource.IdentitySchemaResponse) {
