...
var _ resource.ResourceWithIdentity = &NetworkConfigResource{}
...
func (r *NetworkConfigResource) IdentitySchema(_ context.Context, _ resource.IdentitySchemaRequest, resp *resource.IdentitySchemaResponse) {
