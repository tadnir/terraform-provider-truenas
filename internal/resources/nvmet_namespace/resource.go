...
var _ resource.ResourceWithIdentity = &NVMetNamespaceResource{}
...
func (r *NVMetNamespaceResource) IdentitySchema(_ context.Context, _ resource.IdentitySchemaRequest, resp *resource.IdentitySchemaResponse) {
