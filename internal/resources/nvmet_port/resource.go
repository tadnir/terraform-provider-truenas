...
var _ resource.ResourceWithIdentity = &NVMetPortResource{}
...
func (r *NVMetPortResource) IdentitySchema(_ context.Context, _ resource.IdentitySchemaRequest, resp *resource.IdentitySchemaResponse) {
