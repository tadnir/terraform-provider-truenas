...
var _ resource.ResourceWithIdentity = &PortSubsysResource{}
...
func (r *PortSubsysResource) IdentitySchema(_ context.Context, _ resource.IdentitySchemaRequest, resp *resource.IdentitySchemaResponse) {
