...
func TestListMetadata(t *testing.T) {
	l := &NVMetSubsysListResource{}
	req := resource.MetadataRequest{ProviderTypeName: "truenas"}
	resp := &resource.MetadataResponse{}
	l.Metadata(context.Background(), req, resp)
	if resp.TypeName != "truenas_nvmet_subsys" {
		t.Errorf("TypeName = %q, want %q", resp.TypeName, "truenas_nvmet_subsys")
	}
}

func TestNVMetSubsysIdentitySchema(t *testing.T) {
