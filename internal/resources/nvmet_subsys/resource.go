...
var _ resource.ResourceWithIdentity = &NVMetSubsysResource{}
...
func (r *NVMetSubsysResource) IdentitySchema(_ context.Context, _ resource.IdentitySchemaRequest, resp *resource.IdentitySchemaResponse) {
