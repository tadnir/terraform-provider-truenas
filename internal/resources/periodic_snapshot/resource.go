...
var _ resource.ResourceWithIdentity = &PeriodicSnapshotResource{}
...
func (r *PeriodicSnapshotResource) IdentitySchema(_ context.Context, _ resource.IdentitySchemaRequest, resp *resource.IdentitySchemaResponse) {
