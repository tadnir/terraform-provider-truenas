...
var _ resource.ResourceWithIdentity = &RsyncTaskResource{}
...
func (r *RsyncTaskResource) IdentitySchema(_ context.Context, _ resource.IdentitySchemaRequest, resp *resource.IdentitySchemaResponse) {
