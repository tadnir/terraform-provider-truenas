...
var _ resource.ResourceWithIdentity = &TunableResource{}
...
func (r *TunableResource) IdentitySchema(_ context.Context, _ resource.IdentitySchemaRequest, resp *resource.IdentitySchemaResponse) {
