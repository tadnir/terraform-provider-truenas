...
var _ resource.ResourceWithIdentity = &VMDeviceResource{}
...
func (r *VMDeviceResource) IdentitySchema(_ context.Context, _ resource.IdentitySchemaRequest, resp *resource.IdentitySchemaResponse) {
